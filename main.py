...
class MoodleTest(unittest.TestCase):
  def setUp(self):
    ...
    self.test_case_file_path = 'D:\\Workspace\\selenium\\soft-ware-testing-ass3\\Moodle\\test_case.csv'
    self.result_file_path = 'D:\\Workspace\\selenium\\soft-ware-testing-ass3\\Moodle\\test_result.csv'
